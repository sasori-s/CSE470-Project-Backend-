            ...
            <div className="headerSearchItem">
                ...
                {openOptions && <div className="options">
                    <div className="optionItem">
                        ...
                        <button disabled={options.adult <= 1}  className="optionCouterButton" onClick={()=>handleOption("adult",'d')}>-</button>
                    ...
                    <div className="optionItem">
                        ...
                        <div className="optionCounter">
                        <button disabled={options.children <= 0} className="optionCouterButton" onClick={()=>handleOption("children",'d')}>-</button>
                    ...
                    <div className="optionItem">
                        ...
                        <div className="optionCounter">
                        <button disabled={options.room <= 1} className="optionCouterButton" onClick={()=>handleOption("room",'d')}>-</button>
